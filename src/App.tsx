...
const MainScreen = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto min-h-[100dvh] bg-[#fafafa] relative pb-24 font-sans animate-in fade-in duration-500 shadow-2xl sm:border-x sm:border-gray-100">
      ...
      <div className="pt-8 px-6 pb-4">
        <div className="inline-block p-1.5 border-[2.5px] border-[#00bfa5] rounded-xl bg-white">
          <QrCode className="w-11 h-11 text-black" strokeWidth={1.5} />
        </div>
      </div>

      <div className="px-6 mb-8">
        <div className="bg-white rounded-[20px] p-5 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex justify-between items-start">
          <div className="flex-1 pr-2">
            <h2 className="text-[18px] font-semibold text-gray-900 leading-tight tracking-tight">Cheikh Sidiya Moubareckou</h2>
            <p className="text-gray-500 text-[14px] mt-1.5 tracking-wider">
          ...
          <div className="text-right flex items-center pt-0.5 shrink-0">
            {isDiscreet ? (
              <>
                <span className="text-gray-400 text-[22px] leading-none mt-1">****</span>
                <span className="text-gray-500 font-semibold ml-1.5 text-[15px]">MRU</span>
              </>
            ) : (
              <>
                <span className="text-gray-600 text-[17px] font-semibold leading-none mt-1">100 000 005</span>
                <span className="text-gray-500 font-semibold ml-1.5 text-[15px]">MRU</span>
              </>
            )}
          </div>
      ...
      <div className="px-6">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-5">
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#10b981] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#38bdf8] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#6366f1] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#a855f7] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#f87171] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#fbbf24] flex items-center justify-center shrink-0 overflow-hidden">
      ...
      <div className="px-6 mt-10 sm:mt-12">
        <h3 className="text-gray-500 text-[15px] font-medium mb-4 px-1">Autres</h3>
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 sm:gap-5">
          <div className="bg-white rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.03)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#f59e0b] flex items-center justify-center shrink-0 overflow-hidden">
          ...
          <div className="bg-white/40 rounded-[20px] p-4 shadow-[0_2px_15px_rgba(0,0,0,0.01)] flex items-center space-x-3.5">
            <div className="w-12 h-12 rounded-[14px] bg-[#a7f3d0] flex items-center justify-center shrink-0 opacity-50">
              <Receipt className="w-[22px] h-[22px] text-white" strokeWidth={2} />
            </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 w-full max-w-2xl mx-auto bg-white border-t border-gray-100 flex justify-around items-center px-4 py-3 pb-safe z-50 sm:border-x">
        <div className="flex flex-col items-center space-y-1 w-16 cursor-pointer" onClick={() => setActiveTab('Accueil')}>
          ...
          <span className={`text-[11px] ${activeTab === 'Accueil' ? 'font-semibold text-[#00bfa5]' : 'font-medium text-gray-500'}`}>Accueil</span>
        </div>
        <div className="flex flex-col items-center space-y-1 w-16 cursor-pointer" onClick={() => setActiveTab('Produits')}>
          <ListTodo className={`w-6 h-6 ${activeTab === 'Produits' ? 'text-[#00bfa5]' : 'text-gray-500'}`} strokeWidth={2} />
          <span className={`text-[11px] ${activeTab === 'Produits' ? 'font-semibold text-[#00bfa5]' : 'font-medium text-gray-500'}`}>Produits</span>
        </div>
        <div className="flex flex-col items-center space-y-1 w-16 cursor-pointer" onClick={() => setActiveTab('Menu')}>
          <LayoutGrid className={`w-6 h-6 ${activeTab === 'Menu' ? 'text-[#00bfa5]' : 'text-gray-500'}`} strokeWidth={2} />
          <span className={`text-[11px] ${activeTab === 'Menu' ? 'font-semibold text-[#00bfa5]' : 'font-medium text-gray-500'}`}>Menu</span>
        </div>
      </div>
    </div>
  );
...
export default function App() {
  ...
  if (appState === 'green') {
    return (
      <div className="w-full max-w-2xl mx-auto h-[100dvh] flex flex-col items-center justify-center relative overflow-hidden animate-in fade-in duration-300 sm:shadow-2xl sm:border-x sm:border-gray-100">
  ...
  if (appState === 'white') {
    return (
      <div className="w-full max-w-2xl mx-auto h-[100dvh] bg-white flex flex-col items-center justify-center relative animate-in fade-in duration-300 sm:shadow-2xl sm:border-x sm:border-gray-100">
  ...
  if (appState === 'login') {
    return (
      <div className="w-full max-w-2xl mx-auto h-[100dvh] bg-white flex flex-col relative font-sans animate-in fade-in duration-500 sm:shadow-2xl sm:border-x sm:border-gray-100">
